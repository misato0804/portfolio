    ...
    return (
        <div className="w-full h-[60%]">
            <div className="relative overflow-hidden w-full h-80 z-0 rounded-2xl">
                <video muted loop autoPlay id="background-video" className="min-w-full min-h-full object-cover rounded-2xl">
                    <source src={`${process.env.PUBLIC_URL}/movie.mp4`} type="video/mp4"/>
                </video>

                <div
                    className="absolute bottom-0 hover:opacity-95 opacity-0 duration-300 rounded-2xl bg-gradient-to-b from-[rgba(255,0,0,0)] to-[rgba(62,94,131,.8)] text-slate-50 z-10 text-left px-6 py-4">
